...
const Navbar = ({ isDashboard = false }) => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled || isDashboard ? 'bg-emerald-900/95 backdrop-blur-md shadow-lg py-2' : 'bg-transparent py-4'}`}>
